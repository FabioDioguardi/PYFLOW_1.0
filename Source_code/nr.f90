...
!BL
		...
		INTEGER(I4B), INTENT(IN) :: n
		REAL(dp), DIMENSION(:), INTENT(IN) :: x
		REAL(dp), DIMENSION(size(x)) :: bessj_v
...
!BL
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: x
		REAL(dp), DIMENSION(size(x)) :: bessy0_v
...
!BL
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: x
		REAL(dp), DIMENSION(size(x)) :: bessy1_v
...
!BL
		...
		REAL(dp), DIMENSION(size(n)) :: bico_v
		END FUNCTION bico_v
	END INTERFACE
	INTERFACE
...
!BL
	...
	INTERFACE
		...
		REAL(dp), INTENT(IN) :: a,b
		REAL(dp), DIMENSION(:), INTENT(IN) :: c
		REAL(dp), DIMENSION(size(c)) :: chint
		END FUNCTION chint
	END INTERFACE
	INTERFACE
	...
	INTERFACE
		...
		REAL(dp), DIMENSION(:), INTENT(IN) :: bins,ebins
...
!BL
	...
	INTERFACE
		...
		REAL(dp), INTENT(IN) :: x
		REAL(dp), DIMENSION(:), INTENT(IN) :: c
		REAL(dp), DIMENSION(:), INTENT(OUT) :: pd
...
!BL
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: x
		REAL(dp), DIMENSION(size(x)) :: erfcc_v
...
!BL
		...
		REAL(dp), DIMENSION(size(a)) :: gammp_v
...
!BL
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:,:), INTENT(IN) :: tab
		REAL(dp), INTENT(OUT) :: tau,z,prob
	...
	INTERFACE
		...
		INTERFACE
			...
			END FUNCTION func
		END INTERFACE
		REAL(dp), DIMENSION(:), INTENT(IN) :: regn
		INTEGER(I4B), INTENT(IN) :: ndim,npts
		REAL(dp), INTENT(IN) :: dith
		REAL(dp), INTENT(OUT) :: ave,var
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: x,y,a,sig
...
!BL
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: anu,alpha,beta
...
!BL
	...
	INTERFACE
		...
		REAL(dp), DIMENSION(size(xa)) :: polcof
		END FUNCTION polcof
	END INTERFACE
	INTERFACE
...
!BL
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:,:), INTENT(IN) :: a
		REAL(dp), DIMENSION(:), INTENT(IN) :: c,d
		REAL(dp), DIMENSION(:), INTENT(INOUT) :: b
...
!BL
	...
	INTERFACE
		...
		REAL(dp), DIMENSION(size(a)) :: recur2
		END FUNCTION recur2
	END INTERFACE
	INTERFACE
...
!BL
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: arr
		REAL(dp), DIMENSION(:), INTENT(OUT) :: heap
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(INOUT) :: arr,slave1,slave2
...
!BL
	...
	INTERFACE
		FUNCTION toeplz(r,y)
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: r,y
		REAL(dp), DIMENSION(size(y)) :: toeplz
		END FUNCTION toeplz
	END INTERFACE
	INTERFACE
...
!BL
	...
	INTERFACE
		...
		USE nrtype
		REAL(dp), DIMENSION(:), INTENT(IN) :: a
		REAL(dp), DIMENSION(:), INTENT(OUT) :: rtr,rti
